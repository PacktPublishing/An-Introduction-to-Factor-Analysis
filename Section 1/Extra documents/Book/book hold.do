...
\begin{titlepage}
    \begin{center}
        ...
        \Huge
        \textbf{Understanding Regression}
...
texdoc stlog, cmdstrip nooutput
histogram goals, frequency discrete color(green) lcolor(white) graphregion(color(white)) xtitle(Goals)
texdoc stlog close
...
tex*/
texdoc stlog, cmdstrip nooutput
histogram total_fail, discrete color(green) lcolor(white) graphregion(color(white))
texdoc stlog close
